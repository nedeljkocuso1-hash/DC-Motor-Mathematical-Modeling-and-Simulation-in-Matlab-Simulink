...
### Key Features:
* **Voltage Ramp & Saturation**: Implements a linear voltage increase from $0$ to $400$V over $3$ seconds, utilizing a Saturation block to maintain steady-state nominal voltage.
